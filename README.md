...
```bash
curl -sL https://raw.githubusercontent.com/12EDiTUS/opencode-termux-manager/main/manage_opencode.sh -o manage_opencode.sh && chmod +x manage_opencode.sh && ./manage_opencode.sh
```
